...
export function seedTasks(): {
  ...
  const tasks: Task[] = [
    ...
    },
    {
      ...
      status: "DONE",
      priority: "P3",
      createdById: cleaners[1].id,
      assigneeId: cleaners[1].id,
      createdAt: daysAgo(4),
      updatedAt: daysAgo(1),
      synced: true,
      syncedAt: daysAgo(4),
  ...
  const comments: Comment[] = [
    { id: nanoid(), taskId: tasks[0].id, authorId: caretakers[1].id, text: "On site, isolating water now.", createdAt: hoursAgo(4) },
